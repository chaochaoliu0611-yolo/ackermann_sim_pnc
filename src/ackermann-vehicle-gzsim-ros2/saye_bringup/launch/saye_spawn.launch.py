...
def generate_launch_description():
    ...
    # Convert SDF to URDF for robot_state_publisher (RViz RobotModel needs URDF + TF)
    sys.path.insert(0, os.path.join(pkg_project_description, 'scripts'))
    from sdf_to_urdf import sdf_to_urdf_string
    robot_desc_urdf = sdf_to_urdf_string(robot_desc_sdf)
    ...
    # Takes the URDF description and joint angles as inputs and publishes the 3D poses of the robot links
